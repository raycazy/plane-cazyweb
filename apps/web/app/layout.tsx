...
export const meta = () => [
  ...
  { property: "og:title", content: "cazyweb PM" },
  {
  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Meta info for PWA */}
        <meta name="application-name" content="cazyweb PM" />
